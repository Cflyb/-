...
<div class="right">
        ...
        <div class="providerAdd">
           <fm:form id="providerForm" modelAttribute="provider" enctype="multipart/form-data" name="providerForm" method="post" action="${pageContext.request.contextPath }/provider/addprovidersave.html">
			<input type="hidden" name="method" value="add">
               ...
               <div>
                   <label for="a_companyLicPicPath">营业执照：</label>
                   <input type="file" name="a_companyLicPicPath" id="a_companyLicPicPath"/>
                   <font color="red">${uploadFileError}</font>
               </div> <div>
               <label for="a_orgCodePicPath">组织机构代码证照：</label>
               <input type="file" name="a_orgCodePicPath" id="a_orgCodePicPath"/>
