...
<div class="right">
        ...
        <div class="providerAdd">
            <fm:form id="userForm" modelAttribute="user" name="userForm" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath }/user/addusersave.html">
                ...
                <div>
                    ...
                    <fm:input type="text" Class="Wdate" id="birthday" name="birthday"
					readonly="readonly" onclick="WdatePicker();" path="birthday"/>
