...
<div class="right">
    ...
    <div class="roleAdd">
        <fm:form id="roleForm" modelAttribute="role" enctype="multipart/form-data" name="roleForm" method="post" action="${pageContext.request.contextPath }/role/addrolesave.html">
